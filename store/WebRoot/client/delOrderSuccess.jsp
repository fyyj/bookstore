...
<script type="text/javascript">
	...
	function changeSecond() {
		...
		if (svalue == 0) {
			...
			location.href = window.location.protocol + '//' + window.location.host + '/'+ webName + '/findOrderByUser'; 
			return;
	}
				...
				<td style="padding:30px; text-align:center"><table width="60%"
						...
						<tr>
							...
							<td style="padding-top:30px"><font
								...
								<a href="${pageContext.request.contextPath}/findOrderByUser"><span id="second">5</span>秒后自动为您转跳回订单页面</a>
							</td>
						</tr>
					</table>
					<h1>&nbsp;</h1>
