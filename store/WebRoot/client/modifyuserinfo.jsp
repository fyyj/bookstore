								...
								<table width="100%" border="0" cellspacing="2" class="upline">
									...
									<tr>
										...
										<td style="width:40%; padding-left:20px">
											<input type="text" name="textemail" value="${user.email}"/>
										</td>
										<td>&nbsp;</td>
									</tr>
									...
									<tr>
										...
										<td><input type="password" class="textinput" name="textpwd" /></td>
										<td><font color="#999999">密码设置至少6位，请区分大小写</font></td>
									</tr>
									<tr>
										<td style="text-align:right">性别：</td>
										<td colspan="2">&nbsp;&nbsp;
											<input type="radio" name="textradio" value="男" ${user.gender=='男'?'checked':'' }/> 男
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input type="radio" name="textradio" value="女"  ${user.gender=='女'?'checked':'' }/> 女
										</td>
									</tr>
									<tr>
										<td style="text-align:right">联系方式：</td>
										<td colspan="2">
											<input name="textphone" type="text" value="${user.telephone}" class="textinput" />
										</td>
									</tr>
									<tr>
