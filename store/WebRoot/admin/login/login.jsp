...
<body onload="ini()">
	...
	<c:if test="${not empty msg}">
		<p align="center"><font color="RED" >你不是管理员，无法登陆后台管理界面</font></p>
	</c:if>
	<table width="100%" height="100%">
		<tr>
			<td align="center">
				<table width="452" height="290">
					<tr>
						<td bgcolor="#FFFFFF">
							<table width="452" height="290">
								<tr>
								...
								<tr>
									<td align="center" valign="bottom" background="${pageContext.request.contextPath}/admin/images/loginbg.gif">
										<form id="loginAction_home"  action="${pageContext.request.contextPath}/manageLogin" target="_parent" method="post">
